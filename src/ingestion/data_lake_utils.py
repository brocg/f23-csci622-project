...
Using for various ingestion scripts (fitbit, hevy, polar)
"""
import os
from azure.storage.filedatalake import DataLakeServiceClient

storage_account_name = "assignment1store"
with open("AccountKey.config") as f:
    storage_account_key=f.readline()
file_system_name = "f23-project"
directory_name = "upload-samples"
...
def upload_file_to_data_lake(file_path):
    try:
        ...
        print(f"File '{file_name}' uploaded successfully to {directory_name}/{file_name}")
